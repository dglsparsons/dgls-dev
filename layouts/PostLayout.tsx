...
const editUrl = (fileName: string) =>
  `${siteMetadata.siteRepo}/blob/main/posts/${fileName}`;
...
export const PostLayout: FC<PostLayoutProps> = ({
  ...
  const { slug, fileName, date, title, tags } = metadata;
        ...
        <div className="xl:divide-y xl:divide-gray-200 xl:dark:divide-gray-700">
          ...
          >
            ...
            <div className="divide-y divide-gray-200 dark:divide-gray-700 xl:pb-0 xl:col-span-3 xl:row-span-2">
              ...
              <div className="pt-6 pb-6 text-sm text-gray-700 dark:text-gray-300 flex justify-center gap-3">
